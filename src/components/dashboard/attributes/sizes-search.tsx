// src/components/dashboard/attributes/sizes-search.tsx
"use client";
...
interface SizesSearchProps {
  placeholder?: string;
  className?: string;
  onSearchChange?: (value: string) => void;
}

const SizesSearch: React.FC<SizesSearchProps> = ({ 
  placeholder = "Search sizes by name or slug...",
  className = "",
  onSearchChange = null
}) => {
