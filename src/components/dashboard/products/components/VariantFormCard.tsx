...
import { CompleteProductFormData, VALIDATION_RULES } from "@/lib/validations/product-form";
...
interface VariantFormCardProps {
  ...
  index: number;
  colors: Color[];
  sizes: Size[]; // UPDATED: Now includes nested category
  ...
  return (
    <Card className="p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Size Selection - UPDATED: Removed sizeCategories prop */}
        {showSizes && (
          <FormField
            control={control}
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <SizeCombobox
                    sizes={sizes} // Now includes nested category data
