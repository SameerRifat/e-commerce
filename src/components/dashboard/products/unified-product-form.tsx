...
// ORIGINAL CODE BEFORE IMPLEMENTING UPDATE FUNCTIONALITY
// // src/components/dashboard/products/unified-product-form.tsx
// "use client";
...
// } from "@/lib/validations/product-form";
// import { useStepValidation } from "@/hooks/use-step-validation";
// import { createProduct, type ActionResult } from "@/lib/actions/product-management";
// import { useRef } from "react";
// import type { ImageUploadRef } from "../image-upload";
...
// const UnifiedProductForm: React.FC<UnifiedProductFormProps> = ({ mode, referenceData }) => {
//   const router = useRouter();
//   const [currentStep, setCurrentStep] = useState(0);
//   const [isLoading, setIsLoading] = useState(false);
//   const [submitError, setSubmitError] = useState<string | null>(null);
...
//     try {
//       console.log("Submitting unified product:", JSON.stringify(data, null, 2));
...
//       if (hasPendingImages && imageUploadRef.current) {
//         try {
//           console.log(`🔄 Uploading ${data.images.length} pending images before product creation...`);
//           setSubmitError("Uploading images... Please wait.");
...
//             throw new Error(
//               `Upload failed for ${failedUploads.length} image(s). ` +
//               `All images must be successfully uploaded before creating the product. ` +
//               `Please check your internet connection and try again.`
//             );
//           }
...
//           finalData.images = uploadedImages;
//           console.log(`✅ All ${uploadedImages.length} images uploaded successfully!`);
//           setSubmitError(null); // Clear the "uploading" message
//         } catch (uploadError) {
//           console.error("💥 Image upload failed:", uploadError);
//           setSubmitError(
//             uploadError instanceof Error 
...
//               : "Failed to upload images. Please check your connection and try again."
//           );
//           return; // STOP HERE - Do not create product if images failed
//         }
//       }
...
//       // Create the product using server action (this includes database transaction)
...
//       const result: ActionResult<{ productId: string }> = await createProduct(finalData);
      
//       if (result.success) {
//         console.log("🎉 ATOMIC TRANSACTION COMPLETED SUCCESSFULLY!");
//         console.log("✅ Product created with ID:", result.data?.productId);
//         console.log("✅ Images successfully linked to product");
...
//       <PageHeader
//         title={title}
//         description="Create a complete product with variants, pricing, and inventory in one streamlined flow"
//       >
//         <div className="flex items-center gap-4">
//           <div className="flex items-center gap-2">
//             <Progress value={progressPercentage} className="w-32" />
